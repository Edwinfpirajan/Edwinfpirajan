#!/usr/bin/env python3
"""Generate public GitHub statistics SVGs using only the Python standard library.
...
The featured personal stack lives separately in profile/stack.svg; do not
replace it with computed language shares or attach inferred percentages to it.
...
def main() -> None:
    ...
    print(f"Generated {len(cards)} public-statistics cards for {username}; the curated stack is kept separate.")
